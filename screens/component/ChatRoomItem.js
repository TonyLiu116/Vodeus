...
import whiteChatSvg from '../../assets/common/white_chat.svg';
      ...
      >
        <View style={styles.rowAlignItems}>
          {info.users.map((item, index) => {
            ...
            return <Image
              key={index.toString() + 'chatRoomItem'}
